...
export const useAppData = () => {
  ...
  const allApps = ref([
    ...
    {
      id: 'com.pejoal.personalityai',
      iosId: '6769140300',
      title: 'Personality AI',
      description: 'Discover your personality type with AI insights',
      icon: 'https://lh3.googleusercontent.com/_q_hLSTDsuuNHDHxysbO5zW5bdFCpgFGPHBq_BHzoKAJYcjC4GgQmzV2437Ps28hc3nqc2HSqOwW2Og8HWr4Iw',
      category: 'test',
    },
    // Games
    {
