...
useSeoMeta({
  ...
  ogDescription:
    'Explore 48+ published production mobile applications and full-stack web projects built by Pejoal Hanna.',
  twitterCard: 'summary_large_image',
  twitterTitle: 'Pejoal Hanna — Mobile & Web Software Engineer',
  twitterDescription:
